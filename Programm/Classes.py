...
class SettingsWindow(QWidget):
                ...
                def enterEvent(event):
                    ...
                    if SettingOptions[name].get("Type") == "carousel":
                        ...
                        if button.OptionsContainer is None: 
                            ...
                            CollectionService.addTag(button.OptionsContainer, "optionsContainer")
    ...
    def eventFilter(self, obj, event):
        ...
        if et == QEvent.Type.MouseButtonPress and not self._closing:
            ...
            for i, container in enumerate(CollectionService.getTagged("optionsContainer")):
                container.Animations["hideAnim"].start()
