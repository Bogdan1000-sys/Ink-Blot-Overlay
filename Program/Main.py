...
def RunWMultiprocess(key, args=(), joinProcess=False):
    ...
    selectionWindow.UpdateListeners()
...
class WidgetSelectingWindow(InteractableWindow):
    ...
    def UpdateListeners(self):
        # print("-"*50)
        # print("Listeners:", self.connectionListeners)
        # print("Connections:", uiApp.mpConnections)
        # print("-"*50)
        ...
        # print("Updated Listeners:", self.connectionListeners)
    ...
    def onFastClose(self):
        ...
        for widget in activeWidgets:
            uiApp.mpConnections[widget].send(f"code:Close")
