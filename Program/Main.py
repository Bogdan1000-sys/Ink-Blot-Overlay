...
class WidgetSelectingWindow(InteractableWindow):
    ...
    def UpdatePreviewInfo(self, useSound=True):
        ...
        def TerminateActive():
            ...
            QTimer.singleShot(GetQTime(0.5), lambda: uiApp.multiprocessing.terminateProcesses())
        ...
        def TerimnateCurrent():
            ...
            QTimer.singleShot(GetQTime(0.5), lambda: uiApp.multiprocessing.removeProcess(self.selectedWidget))
