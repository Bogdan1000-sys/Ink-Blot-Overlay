...
# -- Functions --
from Functions import GetUserSettings, applyStyleClass, initSound, playSound, RegisterAdaptableText, AppendUserSettings, GetQTime, CloneAnimation, PrintText
...
class WelcomeWindow(EmptyWindow):
    def __init__(self, **kwargs):
        ...
        self.OptionsContainer.firstLayerContainer.setFixedSize(self.OptionsContainer.width() // 5, self.OptionsContainer.height())
        ...
        self.OptionsContainer.secondLayerContainer.setFixedSize(math.floor(self.OptionsContainer.width() * 4/5) - 10, self.OptionsContainer.height())
        ...
        def startShowing():
            ...
            def printOptions():
                ...
                def createNewLayerOptions(
                    ...
                    def changeDeb():
                        self.debounses["createNewOptionsDebounse"] = False
                    QTimer.singleShot(GetQTime(1), changeDeb)
