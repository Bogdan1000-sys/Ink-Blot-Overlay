...
# -- Functions --
from Functions import GetUserSettings, applyStyleClass, initSound, playSound, RegisterAdaptableText, AppendUserSettings, GetQTime, CloneAnimation, PrintText, RunWidgetProcess, CompareObjects
        ...
        def startShowing():
            ...
            def printOptions():
                ...
                def createSettingWindow():
                    ...
                    self.deleteLater()
                    settingWindow = WidgetSelectingWindow(titleKey="titles/widgetSelection", name="Selection")
