import json
from PyQt6.QtCore import QUrl, QPropertyAnimation, QPoint, Qt
...
# -- Data --
with open("Program/Data/Dictionary.json", "r", encoding="utf-8") as dFile:
...
def GetUserSettings():
    with open("Program/Data/userSettings.json", "r", encoding="utf-8") as usFile:
...
def SetUserSettings(obj):
    ...
    if CompareObjects(OldSettings, NewSettings): 
        ...
        return
    with open("Program/Data/userSettings.json", "w", encoding="utf-8") as usFile:
