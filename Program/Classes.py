...
from PyQt6.QtCore import Qt, QRectF, QPropertyAnimation, QParallelAnimationGroup, QPoint, QTimer, pyqtSignal, QEvent
...
# -- Resources --
mainIcon = 'Program/Resources/Images/Ink Blot Icon.png'

fadeSound = "Program/Resources/SFX/CinematicWhoosh.wav"
buttonClickSound = "Program/Resources/SFX/WidgetSelect.wav"
...
class UIApplication(QApplication):
    def __init__(self, *args, **kwargs):
        ...
        # Включаем глобальное слежение за Alt
    ...
    def __init__(self, text="", size=None, miniTitleKey=None, parent=None):
        ...
        class DragFrame(QFrame):
            ...
            def updateParentPosition(self):
                ...
                parent = self.parent()
                parent.move(
                    self.x() - (parent.width() + 1),
                    self.y() + self.height() // 2 - parent.height() // 2
                )
