...
class MinimizeButton(QPushButton):
    def __init__(self, text="", wIcon="Default", size=None, parent=None):
        ...
        # self.IconLabel = IconLabel(parent=self)
...
class InteractableWindow(QMainWindow):
    ...
    def sideMinimized(self):
        ...
        if not self._data["hidden"]:
            ...
            # self.minimizeButton.MiniController.move(
            #     self.minimizeButton.DragFrame.x() + self.minimizeButton.DragFrame.width() + 1,
            #     self.minimizeButton.DragFrame.y() + self.minimizeButton.DragFrame.height() // 2 - self.minimizeButton.MiniController.height() // 2
            # )
            # self.minimizeButton.IconLabel.move(
            #     self.minimizeButton.DragFrame.x() + self.minimizeButton.DragFrame.width() + 1,
            #     self.minimizeButton.DragFrame.y() + self.minimizeButton.DragFrame.height() // 2 - self.minimizeButton.IconLabel.height() // 2
            # )
            self.minimizeButton.DragFrame.show()
            self.minimizeButton.DragFrame.setProperty("hidden", False)

            # self.minimizeButton.MiniController.show()
            # self.minimizeButton.MiniController.setProperty("hidden", False)

            # self.minimizeButton.IconLabel.show()
            # self.minimizeButton.IconLabel.setProperty("hidden", False)
            ...
            # self.minimizeButton.MiniController.hide()
            # self.minimizeButton.IconLabel.hide()
            self.move(
            ...
            def OnFinished():
                ...
                # self.minimizeButton.MiniController.setProperty("hidden", True)
                # self.minimizeButton.IconLabel.setProperty("hidden", True)
