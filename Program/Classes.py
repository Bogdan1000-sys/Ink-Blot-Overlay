...
class MPushButton(QPushButton):
    def __init__(self, text="", wIcon="PlaceholderIcon", size=None, parent=None):
        super().__init__(text, parent)

        # ----------------------------------------------------------------------

        class MiniControl(QLabel):
        ...
        self.MiniControl = MiniControl(parent=self)
...
class InteractableWindow(QMainWindow):
    ...
    def sideMinimized(self):
        ...
        if not self._data["hidden"]:
            ...
            self.minimizeButton.MiniControl.move(
                self.minimizeButton.DragFrame.x() + self.minimizeButton.DragFrame.width() + 1,
                self.minimizeButton.DragFrame.y() + self.minimizeButton.DragFrame.height() // 2 - self.minimizeButton.MiniControl.height() // 2
            )
            self.minimizeButton.DragFrame.show()
            self.minimizeButton.DragFrame.setProperty("hidden", False)

            # self.minimizeButton.MiniControl.show()
            # self.minimizeButton.MiniControl.setProperty("hidden", False)
            ...
            # self.minimizeButton.MiniControl.hide()
            self.move(
            ...
            def OnFinished():
                ...
                # self.minimizeButton.MiniControl.setProperty("hidden", True)
